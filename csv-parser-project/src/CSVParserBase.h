#ifndef CSVPARSERBASE_H
#define CSVPARSERBASE_H
...
class CSVParserBase : public CSVParser {
protected:
...
public:
    ...
    virtual std::vector<RawRecord> query(const std::string& startDateUTC, const std::string& endDateUTC, 
                                         ...
                                         float distance, const std::string& commaSeparatedPincodeList) override = 0;
};

#endif // CSVPARSERBASE_H